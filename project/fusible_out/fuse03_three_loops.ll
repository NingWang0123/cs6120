; ModuleID = '../fusible_tests/fuse03_three_loops.c'
source_filename = "../fusible_tests/fuse03_three_loops.c"
target datalayout = "e-m:o-p270:32:32-p271:32:32-p272:64:64-i64:64-i128:128-n32:64-S128-Fn32"
target triple = "arm64-apple-macosx26.0.0"

; Function Attrs: nofree noinline norecurse nosync nounwind ssp memory(argmem: write) uwtable(sync)
define void @fuse03_three_loops(ptr noalias noundef writeonly captures(none) %0, ptr noalias noundef writeonly captures(none) %1, ptr noalias noundef writeonly captures(none) %2) local_unnamed_addr #0 {
  br label %4
...
20:                                               ; preds = %11, %20
  ...
  %24 = fadd float %23, 2.000000e+01
  %25 = getelementptr inbounds nuw float, ptr %2, i64 %21
  store float %24, ptr %25, align 4, !tbaa !6
  %26 = add nuw nsw i64 %21, 1
  %27 = icmp eq i64 %26, 1024
  br i1 %27, label %19, label %20, !llvm.loop !16
}
