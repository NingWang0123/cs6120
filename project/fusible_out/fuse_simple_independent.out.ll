; ModuleID = 'fusible_out/fuse_simple_independent.ll'
...
112:                                              ; preds = %112, %9
  ...
  br i1 %119, label %.loopexit1, label %112, !llvm.loop !17

.loopexit:                                        ; preds = %122
  br label %120

120:                                              ; preds = %.loopexit, %110, %89
...
122:                                              ; preds = %122, %62
  ...
  br i1 %129, label %.loopexit, label %122, !llvm.loop !18
