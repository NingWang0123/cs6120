...
define noundef i32 @main(i32 noundef %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #0 {
  %3 = tail call ptr @polybench_alloc_data(i64 noundef 8100, i32 noundef 8) #7
  %4 = ptrtoint ptr %3 to i64
  %5 = tail call ptr @polybench_alloc_data(i64 noundef 8100, i32 noundef 8) #7
...
16:                                               ; preds = %16, %13
  ...
  br i1 %61, label %62, label %16, !llvm.loop !10

62:                                               ; preds = %16, %9
  %63 = phi i64 [ 0, %9 ], [ 88, %16 ]
  br label %64
...
104:                                              ; preds = %99, %104
  ...
  br i1 %173, label %195, label %104, !llvm.loop !21

174:                                              ; preds = %99, %174
  %175 = phi i64 [ %182, %174 ], [ 1, %99 ]
  ...
  br i1 %194, label %195, label %174, !llvm.loop !22

195:                                              ; preds = %104, %174
  %196 = add nuw nsw i64 %100, 1
  %197 = icmp eq i64 %196, 89
  br i1 %197, label %198, label %99, !llvm.loop !23

198:                                              ; preds = %195, %294
  %199 = phi i64 [ %295, %294 ], [ 1, %195 ]
  ...
  br i1 %96, label %273, label %203

203:                                              ; preds = %198, %203
  %204 = phi i64 [ %271, %203 ], [ 0, %198 ]
  ...
  br i1 %272, label %294, label %203, !llvm.loop !29

273:                                              ; preds = %198, %273
  %274 = phi i64 [ %281, %273 ], [ 1, %198 ]
  ...
  br i1 %293, label %294, label %273, !llvm.loop !30
...
306:                                              ; preds = %302
  ...
  %310 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %309, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3) #7
  br label %311
...
323:                                              ; preds = %320, %314
  ...
  %327 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %324, ptr noundef nonnull @.str.5, double noundef %326) #7
...
333:                                              ; preds = %330
  ...
  %335 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %334, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.3) #7
