; ModuleID = 'polybench_results/nussinov.ll'
...
50:                                               ; preds = %40, %26
  ...
  br i1 %53, label %.preheader, label %65

.preheader:                                       ; preds = %50
  br label %54

54:                                               ; preds = %.preheader, %54
  %55 = phi i64 [ %59, %54 ], [ %21, %.preheader ]
  %56 = phi i32 [ %63, %54 ], [ %52, %.preheader ]
  ...
  br i1 %64, label %.loopexit, label %54, !llvm.loop !11

.loopexit:                                        ; preds = %54
  br label %65

65:                                               ; preds = %.loopexit, %50
  %66 = add nuw nsw i64 %27, 1
  %67 = icmp eq i64 %66, 180
  br i1 %67, label %.loopexit1, label %26, !llvm.loop !13

.loopexit1:                                       ; preds = %65
  br label %68

68:                                               ; preds = %.loopexit1, %19
  %69 = add nsw i64 %20, -1
  %70 = icmp eq i64 %20, 0
  %71 = add nsw i64 %21, -1
