; ModuleID = './polybench/linear-algebra/kernels/mvt/mvt.c'
...
59:                                               ; preds = %103, %48
  ...
  br i1 %58, label %93, label %63

63:                                               ; preds = %59, %63
  %64 = phi i64 [ %90, %63 ], [ 0, %59 ]
  %65 = phi double [ %89, %63 ], [ %62, %59 ]
...
93:                                               ; preds = %59, %93
  %94 = phi i64 [ %101, %93 ], [ 0, %59 ]
  %95 = phi double [ %100, %93 ], [ %62, %59 ]
...
103:                                              ; preds = %93, %92
  ...
  br i1 %105, label %106, label %59, !llvm.loop !25

106:                                              ; preds = %103, %120
  %107 = phi i64 [ %121, %120 ], [ 0, %103 ]
...
129:                                              ; preds = %125
  ...
  %133 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %132, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3) #7
  br label %134
...
142:                                              ; preds = %139, %134
  ...
  %146 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %143, ptr noundef nonnull @.str.5, double noundef %145) #7
...
149:                                              ; preds = %142
  ...
  %151 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %150, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.3) #7
  %152 = load ptr, ptr @__stderrp, align 8, !tbaa !31
  %153 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %152, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.7) #7
  br label %154
...
162:                                              ; preds = %159, %154
  ...
  %166 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %163, ptr noundef nonnull @.str.5, double noundef %165) #7
...
169:                                              ; preds = %162
  ...
  %171 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %170, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.7) #7
