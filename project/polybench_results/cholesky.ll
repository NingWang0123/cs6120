; ModuleID = './polybench/linear-algebra/solvers/cholesky/cholesky.c'
...
138:                                              ; preds = %138, %135
  ...
  br i1 %148, label %149, label %138, !llvm.loop !22

149:                                              ; preds = %138, %133
  %150 = phi double [ %134, %133 ], [ %146, %138 ]
...
157:                                              ; preds = %157, %127
  ...
  br i1 %165, label %166, label %157, !llvm.loop !24

166:                                              ; preds = %157, %125
  %167 = phi double [ %126, %125 ], [ %163, %157 ]
