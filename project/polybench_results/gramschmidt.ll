; ModuleID = './polybench/linear-algebra/solvers/gramschmidt/gramschmidt.c'
...
define noundef i32 @main(i32 noundef %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #0 {
  %3 = tail call ptr @polybench_alloc_data(i64 noundef 4800, i32 noundef 8) #8
  %4 = ptrtoint ptr %3 to i64
  %5 = tail call ptr @polybench_alloc_data(i64 noundef 6400, i32 noundef 8) #8
  %6 = tail call ptr @polybench_alloc_data(i64 noundef 4800, i32 noundef 8) #8
...
15:                                               ; preds = %15, %12
  ...
  br i1 %28, label %41, label %15, !llvm.loop !10
...
98:                                               ; preds = %87
  ...
  br i1 %100, label %45, label %74, !llvm.loop !21
...
107:                                              ; preds = %103
  ...
  %111 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %110, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3) #8
  br label %112
...
124:                                              ; preds = %121, %115
  ...
  %128 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %125, ptr noundef nonnull @.str.5, double noundef %127) #8
...
134:                                              ; preds = %131
  ...
  %136 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %135, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.3) #8
  %137 = load ptr, ptr @__stderrp, align 8, !tbaa !25
  %138 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %137, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.7) #8
  br label %139
...
151:                                              ; preds = %148, %142
  ...
  %155 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %152, ptr noundef nonnull @.str.5, double noundef %154) #8
...
161:                                              ; preds = %158
  ...
  %163 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %162, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.7) #8
