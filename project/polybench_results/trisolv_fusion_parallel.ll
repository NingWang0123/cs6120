; ModuleID = 'polybench_results/trisolv.ll'
...
60:                                               ; preds = %60, %58
  ...
  %70 = icmp eq i64 %69, %8
  br i1 %70, label %.loopexit1, label %60, !llvm.loop !14

.loopexit1:                                       ; preds = %60
  br label %71

71:                                               ; preds = %.loopexit1, %56
...
82:                                               ; preds = %.preheader, %82
  %83 = phi i64 [ %91, %82 ], [ 0, %.preheader ]
  %84 = phi double [ %90, %82 ], [ %79, %.preheader ]
  ...
  br i1 %92, label %.loopexit, label %82, !llvm.loop !16

.loopexit:                                        ; preds = %82
  br label %93

93:                                               ; preds = %.loopexit, %76
  %94 = phi double [ %79, %76 ], [ %90, %.loopexit ]
