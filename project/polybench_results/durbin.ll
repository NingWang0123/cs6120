; ModuleID = './polybench/linear-algebra/solvers/durbin/durbin.c'
...
define noundef i32 @main(i32 noundef %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #0 {
  ...
  %4 = tail call ptr @polybench_alloc_data(i64 noundef 120, i32 noundef 8) #9
  %5 = tail call ptr @polybench_alloc_data(i64 noundef 120, i32 noundef 8) #9
  br label %6
...
24:                                               ; preds = %6
  ...
  call void @llvm.lifetime.start.p0(i64 960, ptr nonnull %3) #9
...
142:                                              ; preds = %140, %142
  ...
  br i1 %152, label %153, label %142, !llvm.loop !17
...
159:                                              ; preds = %153
  call void @llvm.lifetime.end.p0(i64 960, ptr nonnull %3) #9
...
165:                                              ; preds = %161
  ...
  %169 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %168, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3) #9
  br label %170
...
178:                                              ; preds = %175, %170
  ...
  %182 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %179, ptr noundef nonnull @.str.5, double noundef %181) #9
...
185:                                              ; preds = %178
  ...
  %187 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %186, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.3) #9
