; ModuleID = 'polybench_results/doitgen.ll'
...
21:                                               ; preds = %77, %8
  ...
  %24 = add i64 %17, %23
  br i1 %11, label %.preheader2, label %77

.preheader2:                                      ; preds = %21
  br label %25

25:                                               ; preds = %.preheader2, %74
  %26 = phi i64 [ %75, %74 ], [ 0, %.preheader2 ]
  %27 = mul nuw nsw i64 %26, 240
  %28 = add i64 %24, %27
  br i1 %12, label %.preheader1, label %74
...
29:                                               ; preds = %64
  ...
  br i1 %31, label %49, label %.preheader

.preheader:                                       ; preds = %29
  br label %32

32:                                               ; preds = %.preheader, %32
  %33 = phi i64 [ %46, %32 ], [ 0, %.preheader ]
...
51:                                               ; preds = %.preheader1, %64
  %52 = phi i64 [ %65, %64 ], [ 0, %.preheader1 ]
...
67:                                               ; preds = %67, %49
  ...
  br i1 %73, label %.loopexit, label %67, !llvm.loop !16

.loopexit:                                        ; preds = %67
  br label %74

74:                                               ; preds = %.loopexit, %48, %25
  %75 = add nuw nsw i64 %26, 1
  %76 = icmp eq i64 %75, %14
  br i1 %76, label %.loopexit3, label %25, !llvm.loop !17

.loopexit3:                                       ; preds = %74
  br label %77

77:                                               ; preds = %.loopexit3, %21
  %78 = add nuw nsw i64 %22, 1
  %79 = icmp eq i64 %78, %13
  br i1 %79, label %.loopexit4, label %21, !llvm.loop !18

.loopexit4:                                       ; preds = %77
  br label %80

80:                                               ; preds = %.loopexit4, %6
  ret void
}
...
123:                                              ; preds = %8
  ...
  br i1 %125, label %.preheader, label %6, !llvm.loop !20

.preheader:                                       ; preds = %123
  br label %126

126:                                              ; preds = %.preheader, %142
  %127 = phi i64 [ %143, %142 ], [ 0, %.preheader ]
