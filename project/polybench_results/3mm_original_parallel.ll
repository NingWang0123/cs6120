; ModuleID = 'polybench_results/3mm.ll'
...
27:                                               ; preds = %14
  ...
  br i1 %29, label %.preheader4, label %10, !llvm.loop !14

.preheader4:                                      ; preds = %27
  br label %30

30:                                               ; preds = %.preheader4, %48
  %31 = phi i64 [ %49, %48 ], [ 0, %.preheader4 ]
...
48:                                               ; preds = %34
  ...
  br i1 %50, label %.preheader3, label %30, !llvm.loop !16

.preheader3:                                      ; preds = %48
  br label %51

51:                                               ; preds = %.preheader3, %68
  %52 = phi i64 [ %69, %68 ], [ 0, %.preheader3 ]
...
68:                                               ; preds = %55
  ...
  br i1 %70, label %.preheader2, label %51, !llvm.loop !18

.preheader2:                                      ; preds = %68
  br label %71

71:                                               ; preds = %.preheader2, %89
  %72 = phi i64 [ %90, %89 ], [ 0, %.preheader2 ]
...
111:                                              ; preds = %108
  ...
  br i1 %113, label %.preheader1, label %93, !llvm.loop !23

.preheader1:                                      ; preds = %111
  br label %114

114:                                              ; preds = %.preheader1, %132
  %115 = phi i64 [ %133, %132 ], [ 0, %.preheader1 ]
  br label %116
...
132:                                              ; preds = %129
  ...
  br i1 %134, label %.preheader, label %114, !llvm.loop !26

.preheader:                                       ; preds = %132
  br label %135

135:                                              ; preds = %.preheader, %153
  %136 = phi i64 [ %154, %153 ], [ 0, %.preheader ]
  br label %137
