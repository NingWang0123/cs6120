; ModuleID = 'polybench_results/lu.ll'
...
42:                                               ; preds = %42, %40
  ...
  %51 = icmp eq i64 %50, %7
  br i1 %51, label %.loopexit6, label %42, !llvm.loop !14

.loopexit6:                                       ; preds = %42
  br label %52

52:                                               ; preds = %.loopexit6, %38
...
91:                                               ; preds = %116, %88
  ...
  br i1 %90, label %.preheader, label %.preheader4
...
93:                                               ; preds = %.preheader4, %93
  %94 = phi i64 [ %107, %93 ], [ 0, %.preheader4 ]
  ...
  br i1 %108, label %.loopexit5, label %93, !llvm.loop !19
...
109:                                              ; preds = %.preheader, %109
  ...
  br i1 %115, label %.loopexit3, label %109, !llvm.loop !20
...
133:                                              ; preds = %133, %130
  ...
  br i1 %143, label %.loopexit1, label %133, !llvm.loop !22

.loopexit1:                                       ; preds = %133
  br label %144

144:                                              ; preds = %.loopexit1, %128
  %145 = phi double [ %129, %128 ], [ %141, %.loopexit1 ]
  ...
  br i1 %151, label %.loopexit2, label %125, !llvm.loop !23

.loopexit2:                                       ; preds = %144
  br label %152

152:                                              ; preds = %.loopexit2, %120
  br label %153
...
158:                                              ; preds = %158, %155
  ...
  br i1 %168, label %.loopexit, label %158, !llvm.loop !24

.loopexit:                                        ; preds = %158
  br label %169

169:                                              ; preds = %.loopexit, %153
