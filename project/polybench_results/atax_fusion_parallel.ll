; ModuleID = 'polybench_results/atax.ll'
...
define noundef i32 @main(i32 noundef %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #0 {
  ...
  %4 = tail call ptr @polybench_alloc_data(i64 noundef 124, i32 noundef 8) #7
...
120:                                              ; preds = %207, %101
  ...
  br i1 %112, label %153, label %.preheader

.preheader:                                       ; preds = %120
  br label %123

123:                                              ; preds = %.preheader, %123
  %124 = phi i64 [ %150, %123 ], [ 0, %.preheader ]
  %125 = phi double [ %149, %123 ], [ 0.000000e+00, %.preheader ]
...
171:                                              ; preds = %171, %167
  ...
  br i1 %194, label %.loopexit, label %171, !llvm.loop !34

.loopexit:                                        ; preds = %171
  br label %195

195:                                              ; preds = %.loopexit, %166
  %196 = phi i64 [ 0, %166 ], [ 120, %.loopexit ]
  br label %197
...
216:                                              ; preds = %212
  ...
  %220 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %219, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3) #7
  br label %221
...
229:                                              ; preds = %226, %221
  ...
  %233 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %230, ptr noundef nonnull @.str.5, double noundef %232) #7
...
236:                                              ; preds = %229
  ...
  %238 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %237, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.3) #7
