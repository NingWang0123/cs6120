; ModuleID = './polybench/stencils/adi/adi.c'
...
88:                                               ; preds = %69, %88
  ...
  br i1 %111, label %140, label %88, !llvm.loop !15
...
119:                                              ; preds = %119, %112
  ...
  br i1 %139, label %140, label %119, !llvm.loop !15
...
155:                                              ; preds = %143
  ...
  %157 = add i64 %70, 1
  br i1 %156, label %158, label %69, !llvm.loop !17

158:                                              ; preds = %155, %243
  %159 = phi i64 [ %246, %243 ], [ 0, %155 ]
  %160 = phi i64 [ %244, %243 ], [ 1, %155 ]
...
178:                                              ; preds = %158, %178
  ...
  br i1 %201, label %230, label %178, !llvm.loop !18
...
209:                                              ; preds = %209, %202
  ...
  br i1 %229, label %230, label %209, !llvm.loop !18
