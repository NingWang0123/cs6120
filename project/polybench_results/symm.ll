; ModuleID = './polybench/linear-algebra/blas/symm/symm.c'
...
18:                                               ; preds = %18, %13
  ...
  br i1 %35, label %52, label %18, !llvm.loop !10
...
131:                                              ; preds = %131, %129
  ...
  br i1 %146, label %147, label %131, !llvm.loop !19

147:                                              ; preds = %131, %127
  %148 = phi double [ 0.000000e+00, %127 ], [ %144, %131 ]
