; ModuleID = 'polybench_results/jacobi-1d.ll'
...
define noundef i32 @main(i32 noundef %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #0 {
  ...
  %7 = sub i64 %5, %6
  %8 = icmp ult i64 %7, 64
  br i1 %8, label %.preheader3, label %.preheader5
...
9:                                                ; preds = %.preheader5, %9
  %10 = phi i64 [ %44, %9 ], [ 0, %.preheader5 ]
  %11 = phi <2 x i32> [ %45, %9 ], [ <i32 0, i32 1>, %.preheader5 ]
  ...
  br i1 %46, label %.loopexit6, label %9, !llvm.loop !10

47:                                               ; preds = %.preheader3, %47
  %48 = phi i64 [ %58, %47 ], [ 0, %.preheader3 ]
  ...
  br i1 %59, label %.loopexit4, label %47, !llvm.loop !14
...
73:                                               ; preds = %200, %60
  ...
  br i1 %69, label %121, label %.preheader1

.preheader1:                                      ; preds = %73
  br label %75

75:                                               ; preds = %.preheader1, %75
  %76 = phi i64 [ %119, %75 ], [ 0, %.preheader1 ]
  ...
  br i1 %120, label %.loopexit2, label %75, !llvm.loop !20

.loopexit2:                                       ; preds = %75
  br label %121

121:                                              ; preds = %.loopexit2, %73
  %122 = phi i64 [ 1, %73 ], [ 113, %.loopexit2 ]
  br label %123
...
137:                                              ; preds = %123
  br i1 %72, label %184, label %.preheader

.preheader:                                       ; preds = %137
  br label %138

138:                                              ; preds = %.preheader, %138
  %139 = phi i64 [ %182, %138 ], [ 0, %.preheader ]
  ...
  br i1 %183, label %.loopexit, label %138, !llvm.loop !27

.loopexit:                                        ; preds = %138
  br label %184

184:                                              ; preds = %.loopexit, %137
  %185 = phi i64 [ 1, %137 ], [ 113, %.loopexit ]
  br label %186
