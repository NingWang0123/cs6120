; ModuleID = 'polybench_results/covariance.ll'
...
99:                                               ; preds = %271, %54
  ...
  br i1 %59, label %.preheader1, label %101
...
262:                                              ; preds = %.preheader1, %262
  %263 = phi i64 [ %269, %262 ], [ 0, %.preheader1 ]
  ...
  br i1 %270, label %.loopexit, label %262, !llvm.loop !22

.loopexit:                                        ; preds = %262
  br label %271

271:                                              ; preds = %.loopexit, %101
  %272 = add nuw nsw i64 %100, 1
  %273 = icmp eq i64 %272, 100
  br i1 %273, label %.preheader, label %99, !llvm.loop !23

.preheader:                                       ; preds = %271
  br label %274

274:                                              ; preds = %.preheader, %294
  %275 = phi i64 [ %295, %294 ], [ 0, %.preheader ]
  br label %276
