; ModuleID = 'polybench_results/deriche.ll'
...
49:                                               ; preds = %34
  ...
  br i1 %51, label %.preheader5, label %32, !llvm.loop !16

.preheader5:                                      ; preds = %49
  br label %52

52:                                               ; preds = %.preheader5, %69
  %53 = phi i64 [ %70, %69 ], [ 0, %.preheader5 ]
  br label %54
...
78:                                               ; preds = %283, %72
  ...
  br i1 %77, label %.preheader3, label %80
...
273:                                              ; preds = %.preheader3, %273
  %274 = phi i64 [ %281, %273 ], [ 0, %.preheader3 ]
  ...
  br i1 %282, label %.loopexit4, label %273, !llvm.loop !19

.loopexit4:                                       ; preds = %273
  br label %283

283:                                              ; preds = %.loopexit4, %80
  %284 = add nuw nsw i64 %79, 1
  %285 = icmp eq i64 %284, 192
  br i1 %285, label %.preheader2, label %78, !llvm.loop !20

.preheader2:                                      ; preds = %283
  br label %286

286:                                              ; preds = %.preheader2, %303
  %287 = phi i64 [ %304, %303 ], [ 0, %.preheader2 ]
  br label %288
...
303:                                              ; preds = %288
  ...
  br i1 %305, label %.preheader1, label %286, !llvm.loop !22

.preheader1:                                      ; preds = %303
  br label %306

306:                                              ; preds = %.preheader1, %323
  %307 = phi i64 [ %324, %323 ], [ 0, %.preheader1 ]
  br label %308
...
332:                                              ; preds = %537, %326
  ...
  br i1 %331, label %.preheader, label %334
...
527:                                              ; preds = %.preheader, %527
  %528 = phi i64 [ %535, %527 ], [ 0, %.preheader ]
  ...
  br i1 %536, label %.loopexit, label %527, !llvm.loop !25

.loopexit:                                        ; preds = %527
  br label %537

537:                                              ; preds = %.loopexit, %334
