; ModuleID = 'polybench_results/heat-3d.ll'
...
define noundef i32 @main(i32 noundef %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #0 {
  ...
  %5 = tail call ptr @polybench_alloc_data(i64 noundef 8000, i32 noundef 8) #6
...
118:                                              ; preds = %183, %104
  ...
  br i1 %117, label %.preheader3, label %.preheader5

.preheader5:                                      ; preds = %118
  br label %122

.preheader3:                                      ; preds = %118
  br label %153

122:                                              ; preds = %.preheader5, %122
  %123 = phi i64 [ %151, %122 ], [ 0, %.preheader5 ]
  ...
  br i1 %152, label %.loopexit6, label %122, !llvm.loop !20

153:                                              ; preds = %.preheader3, %153
  %154 = phi i64 [ %171, %153 ], [ 1, %.preheader3 ]
  ...
  br i1 %182, label %.loopexit4, label %153, !llvm.loop !22
...
185:                                              ; preds = %183
  ...
  %188 = add i64 %105, 1
  br i1 %187, label %.preheader7, label %104, !llvm.loop !24

.preheader7:                                      ; preds = %185
  br label %189

189:                                              ; preds = %.preheader7, %270
  %190 = phi i64 [ %273, %270 ], [ 0, %.preheader7 ]
  %191 = phi i64 [ %271, %270 ], [ 1, %.preheader7 ]
...
203:                                              ; preds = %268, %189
  ...
  br i1 %202, label %.preheader, label %.preheader1
...
207:                                              ; preds = %.preheader1, %207
  %208 = phi i64 [ %236, %207 ], [ 0, %.preheader1 ]
  ...
  br i1 %237, label %.loopexit2, label %207, !llvm.loop !30

238:                                              ; preds = %.preheader, %238
  %239 = phi i64 [ %256, %238 ], [ 1, %.preheader ]
  ...
  br i1 %267, label %.loopexit, label %238, !llvm.loop !31
...
283:                                              ; preds = %279
  ...
  %287 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %286, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3) #6
  br label %288
...
304:                                              ; preds = %301, %295
  ...
  %308 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %305, ptr noundef nonnull @.str.5, double noundef %307) #6
...
317:                                              ; preds = %314
  ...
  %319 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %318, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.3) #6
