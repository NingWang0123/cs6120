...
#include "/Users/wangning/Desktop/cornell_repos/cs6120/project/fusible_tests/fuse23_mixed_outputs.c"
...
int main(void) {
  ...
  // warmup
#if 0
  fuse23_mixed_outputs(a, b, (int)N);
#else
  fuse23_mixed_outputs(a, b);
#endif
