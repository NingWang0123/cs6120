...
#include "/Users/wangning/Desktop/cornell_repos/cs6120/project/fusible_tests/fuse18_uint32_bitops.c"
...
int main(void) {
  ...
  // warmup
#if 0
  fuse18_uint32_bitops(a, b, (int)N);
#else
  fuse18_uint32_bitops(a, b);
#endif
