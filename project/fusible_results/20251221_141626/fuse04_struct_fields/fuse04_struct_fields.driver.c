...
#include "/Users/wangning/Desktop/cornell_repos/cs6120/project/fusible_tests/fuse04_struct_fields.c"
...
int main(void) {
  ...
  // warmup
#if 0
  fuse04_struct_fields(a, b, (int)N);
#else
  fuse04_struct_fields(a, b);
#endif
