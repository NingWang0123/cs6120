; ModuleID = '/Users/wangning/Desktop/cornell_repos/cs6120/project/fusible_results/20251221_141626/fuse17_flat_2d/fuse17_flat_2d.OriginalPass.ll'
source_filename = "/Users/wangning/Desktop/cornell_repos/cs6120/project/fusible_results/20251221_141626/fuse17_flat_2d/fuse17_flat_2d.driver.c"
...
14:                                               ; preds = %.preheader, %14
  %15 = phi i64 [ %22, %14 ], [ 0, %.preheader ]
  %16 = trunc nuw nsw i64 %15 to i32
  %17 = and i32 %16, 127
  %18 = lshr i32 %16, 7
  %19 = sub nsw i32 %17, %18
  %20 = sitofp i32 %19 to float
  %21 = getelementptr inbounds nuw float, ptr %1, i64 %15
  store float %20, ptr %21, align 4, !tbaa !6
  %22 = add nuw nsw i64 %15, 1
  %23 = icmp eq i64 %22, 16384
  br i1 %23, label %13, label %14, !llvm.loop !15
}
...
define range(i32 0, 3) i32 @main() local_unnamed_addr #2 {
  %1 = tail call align 64 dereferenceable_or_null(65536) ptr @aligned_alloc(i64 noundef 64, i64 noundef 65536) #8
  %2 = tail call align 64 dereferenceable_or_null(65536) ptr @aligned_alloc(i64 noundef 64, i64 noundef 65536) #8
...
6:                                                ; preds = %0
  tail call void @fuse17_flat_2d(ptr noundef nonnull %1, ptr noundef nonnull %2)
