; ModuleID = '/Users/wangning/Desktop/cornell_repos/cs6120/project/fusible_results/20251221_141626/fuse11_affine_float/fuse11_affine_float.Fusion+Shared.ll'
source_filename = "/Users/wangning/Desktop/cornell_repos/cs6120/project/fusible_results/20251221_141626/fuse11_affine_float/fuse11_affine_float.driver.c"
...
define void @fuse11_affine_float(ptr noalias noundef writeonly captures(none) %0, ptr noalias noundef writeonly captures(none) %1) local_unnamed_addr #0 {
  br label %3
...
3:                                                ; preds = %3, %2
  ...
  %7 = tail call float @llvm.fmuladd.f32(float %6, float 1.250000e+00, float 3.000000e+00)
  ...
  %13 = tail call float @llvm.fmuladd.f32(float %12, float 7.500000e-01, float -2.000000e+00)
  %14 = getelementptr inbounds nuw float, ptr %1, i64 %4
...
6:                                                ; preds = %0
  tail call void @fuse11_affine_float(ptr noundef nonnull %1, ptr noundef nonnull %2)
