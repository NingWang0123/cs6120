; ModuleID = '/Users/wangning/Desktop/cornell_repos/cs6120/project/fusible_results/20251221_141626/fuse12_affine_double/fuse12_affine_double.Fusion+Shared.ll'
source_filename = "/Users/wangning/Desktop/cornell_repos/cs6120/project/fusible_results/20251221_141626/fuse12_affine_double/fuse12_affine_double.driver.c"
...
define void @fuse12_affine_double(ptr noalias noundef writeonly captures(none) %0, ptr noalias noundef writeonly captures(none) %1) local_unnamed_addr #0 {
  br label %3
...
3:                                                ; preds = %3, %2
  ...
  %7 = tail call double @llvm.fmuladd.f64(double %6, double 1.125000e+00, double 7.000000e+00)
  %8 = getelementptr inbounds nuw double, ptr %0, i64 %4
  store double %7, ptr %8, align 8, !tbaa !6
  %9 = add nuw nsw i64 %4, 1
  %10 = icmp eq i64 %9, 1048576
  %11 = trunc nuw nsw i64 %4 to i32
  %12 = uitofp nneg i32 %11 to double
  %13 = tail call double @llvm.fmuladd.f64(double %12, double 6.250000e-01, double -1.000000e+00)
  %14 = getelementptr inbounds nuw double, ptr %1, i64 %4
  store double %13, ptr %14, align 8, !tbaa !6
  %15 = add nuw nsw i64 %4, 1
  %16 = icmp eq i64 %15, 1048576
...
6:                                                ; preds = %0
  tail call void @fuse12_affine_double(ptr noundef nonnull %1, ptr noundef nonnull %2)
