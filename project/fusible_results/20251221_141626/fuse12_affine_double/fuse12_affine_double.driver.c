...
#include "/Users/wangning/Desktop/cornell_repos/cs6120/project/fusible_tests/fuse12_affine_double.c"
...
int main(void) {
  ...
  // warmup
#if 0
  fuse12_affine_double(a, b, (int)N);
#else
  fuse12_affine_double(a, b);
#endif
