...
#include "/Users/wangning/Desktop/cornell_repos/cs6120/project/fusible_tests/fuse20_two_out_two_in.c"
...
int main(void) {
  ...
  // warmup
#if 0
  fuse20_two_out_two_in(a, b, (int)N);
#else
  fuse20_two_out_two_in(a, b);
#endif
