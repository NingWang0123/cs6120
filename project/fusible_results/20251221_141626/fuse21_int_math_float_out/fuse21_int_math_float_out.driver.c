...
#include "/Users/wangning/Desktop/cornell_repos/cs6120/project/fusible_tests/fuse21_int_math_float_out.c"
...
int main(void) {
  ...
  // warmup
#if 0
  fuse21_int_math_float_out(a, b, (int)N);
#else
  fuse21_int_math_float_out(a, b);
#endif
