...
#include "/Users/wangning/Desktop/cornell_repos/cs6120/project/fusible_tests/fuse13_two_out_one_in.c"
...
int main(void) {
  ...
  // warmup
#if 0
  fuse13_two_out_one_in(a, b, (int)N);
#else
  fuse13_two_out_one_in(a, b);
#endif
