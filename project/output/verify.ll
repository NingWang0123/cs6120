; ModuleID = 'tests/verify_correctness.c'
...
73:                                               ; preds = %12, %73
  ...
  br i1 %82, label %72, label %73, !llvm.loop !15
}
...
63:                                               ; preds = %14, %63
  ...
  %70 = icmp eq i64 %69, %9
  br i1 %70, label %62, label %63, !llvm.loop !18
}
...
73:                                               ; preds = %12, %73
  ...
  %81 = add nuw nsw i64 %74, 1
  %82 = icmp eq i64 %81, %10
  br i1 %82, label %72, label %73, !llvm.loop !21
}
...
30:                                               ; preds = %10, %28
  ...
  %33 = icmp eq i64 %32, %7
  br i1 %33, label %8, label %10, !llvm.loop !22
}
...
75:                                               ; preds = %75, %74
  ...
  br i1 %102, label %103, label %75, !llvm.loop !25

103:                                              ; preds = %75, %123
  %104 = phi i64 [ %125, %123 ], [ 0, %75 ]
  %105 = phi i32 [ %124, %123 ], [ 0, %75 ]
...
132:                                              ; preds = %132, %127
  ...
  br i1 %151, label %152, label %132, !llvm.loop !26

152:                                              ; preds = %132, %152
  %153 = phi i64 [ %170, %152 ], [ 0, %132 ]
  ...
  br i1 %171, label %172, label %152, !llvm.loop !27

172:                                              ; preds = %152, %192
  %173 = phi i64 [ %194, %192 ], [ 0, %152 ]
  %174 = phi i32 [ %193, %192 ], [ 0, %152 ]
...
201:                                              ; preds = %201, %196
  ...
  br i1 %228, label %229, label %201, !llvm.loop !28

229:                                              ; preds = %201, %229
  %230 = phi i64 [ %255, %229 ], [ 0, %201 ]
...
257:                                              ; preds = %229, %277
  %258 = phi i64 [ %279, %277 ], [ 0, %229 ]
  %259 = phi i32 [ %278, %277 ], [ 0, %229 ]
