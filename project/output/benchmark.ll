...
78:                                               ; preds = %12, %78
  ...
  br i1 %88, label %77, label %78, !llvm.loop !20
}
...
68:                                               ; preds = %15, %68
  ...
  br i1 %75, label %67, label %68, !llvm.loop !23
}
...
83:                                               ; preds = %12, %83
  ...
  br i1 %94, label %82, label %83, !llvm.loop !26
}
...
define noundef i32 @main(i32 noundef %0, ptr noundef readnone captures(none) %1) local_unnamed_addr #5 {
  ...
  %10 = tail call dereferenceable_or_null(200000000) ptr @malloc(i64 noundef 200000000) #10
  %11 = tail call dereferenceable_or_null(200000000) ptr @malloc(i64 noundef 200000000) #10
  %12 = tail call dereferenceable_or_null(200000000) ptr @malloc(i64 noundef 200000000) #10
  br label %13
