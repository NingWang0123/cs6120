; ModuleID = './polybench/datamining/correlation/correlation.c'
...
93:                                               ; preds = %130, %82
  ...
  br i1 %92, label %117, label %95

95:                                               ; preds = %93, %95
  %96 = phi i64 [ %115, %95 ], [ 0, %93 ]
  ...
  br i1 %116, label %130, label %95, !llvm.loop !27

117:                                              ; preds = %93, %117
  %118 = phi i64 [ %128, %117 ], [ 0, %93 ]
  ...
  br i1 %129, label %130, label %117, !llvm.loop !28

130:                                              ; preds = %95, %117
  %131 = add nuw nsw i64 %94, 1
  %132 = icmp eq i64 %131, 100
  br i1 %132, label %137, label %93, !llvm.loop !29
...
137:                                              ; preds = %130, %133
  %138 = phi i64 [ %134, %133 ], [ 0, %130 ]
  %139 = phi i64 [ %135, %133 ], [ 1, %130 ]
