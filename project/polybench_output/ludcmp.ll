; ModuleID = './polybench/linear-algebra/solvers/ludcmp/ludcmp.c'
...
define noundef i32 @main(i32 noundef %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #0 {
  %3 = tail call ptr @polybench_alloc_data(i64 noundef 14400, i32 noundef 8) #8
  %4 = ptrtoint ptr %3 to i64
  %5 = tail call ptr @polybench_alloc_data(i64 noundef 120, i32 noundef 8) #8
  %6 = tail call ptr @polybench_alloc_data(i64 noundef 120, i32 noundef 8) #8
  %7 = tail call ptr @polybench_alloc_data(i64 noundef 120, i32 noundef 8) #8
...
19:                                               ; preds = %2, %19
  %20 = phi i64 [ %58, %19 ], [ 0, %2 ]
  %21 = phi <2 x i64> [ %59, %19 ], [ <i64 0, i64 1>, %2 ]
  ...
  br i1 %60, label %73, label %19, !llvm.loop !10

61:                                               ; preds = %2, %61
  %62 = phi i64 [ %65, %61 ], [ 0, %2 ]
...
133:                                              ; preds = %129
  %134 = tail call ptr @polybench_alloc_data(i64 noundef 14400, i32 noundef 8) #8
...
162:                                              ; preds = %160, %162
  ...
  br i1 %177, label %185, label %162, !llvm.loop !21

178:                                              ; preds = %160, %178
  %179 = phi i64 [ %183, %178 ], [ 0, %160 ]
  ...
  br i1 %184, label %185, label %178, !llvm.loop !22
...
197:                                              ; preds = %192, %197
  ...
  %199 = phi double [ %205, %197 ], [ %195, %192 ]
...
208:                                              ; preds = %197, %192
  %209 = phi double [ %195, %192 ], [ %205, %197 ]
  ...
  br i1 %214, label %215, label %192, !llvm.loop !25
...
216:                                              ; preds = %215, %231
  ...
  br i1 %191, label %231, label %220

220:                                              ; preds = %216, %220
  %221 = phi i64 [ %229, %220 ], [ 0, %216 ]
  ...
  br i1 %230, label %231, label %220, !llvm.loop !26

231:                                              ; preds = %220, %216
  %232 = phi double [ %219, %216 ], [ %228, %220 ]
...
235:                                              ; preds = %231
  ...
  br i1 %237, label %238, label %189, !llvm.loop !28

238:                                              ; preds = %235, %296
  %239 = phi i64 [ %299, %296 ], [ 0, %235 ]
...
285:                                              ; preds = %282, %285
  ...
  br i1 %295, label %296, label %285, !llvm.loop !30

296:                                              ; preds = %285, %280, %238
  %297 = phi double [ %241, %238 ], [ %277, %280 ], [ %293, %285 ]
  ...
  br i1 %300, label %301, label %238, !llvm.loop !31

301:                                              ; preds = %296, %363
  %302 = phi i64 [ %371, %363 ], [ 0, %296 ]
  %303 = phi i64 [ %369, %363 ], [ 119, %296 ]
...
352:                                              ; preds = %349, %352
  ...
  br i1 %362, label %363, label %352, !llvm.loop !33

363:                                              ; preds = %352, %347, %301
  %364 = phi double [ %305, %301 ], [ %344, %347 ], [ %361, %352 ]
...
378:                                              ; preds = %374
  ...
  %382 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %381, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3) #8
  br label %383
...
391:                                              ; preds = %388, %383
  ...
  %395 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %392, ptr noundef nonnull @.str.5, double noundef %394) #8
...
398:                                              ; preds = %391
  ...
  %400 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %399, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.3) #8
