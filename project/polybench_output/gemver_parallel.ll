; ModuleID = 'polybench_output/gemver.ll'
...
define noundef i32 @main(i32 noundef %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #0 {
  ...
  %8 = tail call ptr @polybench_alloc_data(i64 noundef 120, i32 noundef 8) #6
  %9 = tail call ptr @polybench_alloc_data(i64 noundef 120, i32 noundef 8) #6
  %10 = tail call ptr @polybench_alloc_data(i64 noundef 120, i32 noundef 8) #6
  %11 = tail call ptr @polybench_alloc_data(i64 noundef 120, i32 noundef 8) #6
  br label %12
...
70:                                               ; preds = %131, %49
  ...
  br i1 %69, label %.preheader7, label %74
...
81:                                               ; preds = %81, %74
  ...
  br i1 %116, label %.loopexit9, label %81, !llvm.loop !27

117:                                              ; preds = %.preheader7, %117
  %118 = phi i64 [ %129, %117 ], [ 0, %.preheader7 ]
  ...
  br i1 %130, label %.loopexit8, label %117, !llvm.loop !28
...
131:                                              ; preds = %.loopexit9, %.loopexit8
  %132 = add nuw nsw i64 %71, 1
  %133 = icmp eq i64 %132, 120
  br i1 %133, label %.preheader6, label %70, !llvm.loop !29

.preheader6:                                      ; preds = %131
  br label %134

134:                                              ; preds = %.preheader6, %149
  %135 = phi i64 [ %150, %149 ], [ 0, %.preheader6 ]
...
152:                                              ; preds = %149
  ...
  %157 = and i1 %155, %156
  br i1 %157, label %.preheader2, label %.preheader4

.preheader4:                                      ; preds = %152
  br label %158

.preheader2:                                      ; preds = %152
  br label %182

158:                                              ; preds = %.preheader4, %158
  %159 = phi i64 [ %180, %158 ], [ 0, %.preheader4 ]
  ...
  br i1 %181, label %.loopexit5, label %158, !llvm.loop !37

182:                                              ; preds = %.preheader2, %182
  %183 = phi i64 [ %189, %182 ], [ 0, %.preheader2 ]
  ...
  br i1 %190, label %.loopexit3, label %182, !llvm.loop !38
...
202:                                              ; preds = %251, %191
  ...
  br i1 %201, label %.preheader, label %.preheader1

.preheader1:                                      ; preds = %202
  br label %206

.preheader:                                       ; preds = %202
  br label %240

206:                                              ; preds = %.preheader1, %206
  %207 = phi i64 [ %237, %206 ], [ 0, %.preheader1 ]
  %208 = phi double [ %236, %206 ], [ %205, %.preheader1 ]
...
240:                                              ; preds = %.preheader, %240
  %241 = phi i64 [ %249, %240 ], [ 0, %.preheader ]
  %242 = phi double [ %248, %240 ], [ %205, %.preheader ]
  ...
  br i1 %250, label %.loopexit, label %240, !llvm.loop !48

.loopexit:                                        ; preds = %240
  br label %251

251:                                              ; preds = %.loopexit, %239
...
260:                                              ; preds = %256
  ...
  %264 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %263, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3) #6
  br label %265
...
280:                                              ; preds = %273
  ...
  %282 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %281, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.3) #6
