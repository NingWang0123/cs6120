; ModuleID = './polybench/linear-algebra/kernels/2mm/2mm.c'
...
45:                                               ; preds = %32
  ...
  br i1 %47, label %48, label %28, !llvm.loop !16
...
66:                                               ; preds = %52
  ...
  br i1 %68, label %69, label %48, !llvm.loop !18
...
109:                                              ; preds = %106
  ...
  br i1 %111, label %112, label %90, !llvm.loop !23

112:                                              ; preds = %109, %132
  %113 = phi i64 [ %133, %132 ], [ 0, %109 ]
  br label %114
