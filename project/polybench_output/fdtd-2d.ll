; ModuleID = './polybench/stencils/fdtd-2d/fdtd-2d.c'
...
define noundef i32 @main(i32 noundef %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #0 {
  ...
  %4 = tail call ptr @polybench_alloc_data(i64 noundef 4800, i32 noundef 8) #7
  %5 = tail call ptr @polybench_alloc_data(i64 noundef 4800, i32 noundef 8) #7
  %6 = tail call ptr @polybench_alloc_data(i64 noundef 40, i32 noundef 8) #7
...
120:                                              ; preds = %114, %170
  ...
  br i1 %103, label %158, label %122

122:                                              ; preds = %120, %122
  %123 = phi i64 [ %156, %122 ], [ 0, %120 ]
  ...
  br i1 %157, label %170, label %122, !llvm.loop !18

158:                                              ; preds = %120, %158
  %159 = phi i64 [ %168, %158 ], [ 0, %120 ]
  ...
  br i1 %169, label %170, label %158, !llvm.loop !21

170:                                              ; preds = %122, %158
  %171 = add nuw nsw i64 %121, 1
  %172 = icmp eq i64 %171, 60
  br i1 %172, label %173, label %120, !llvm.loop !22

173:                                              ; preds = %170, %227
  %174 = phi i64 [ %228, %227 ], [ 0, %170 ]
  br i1 %106, label %212, label %175

175:                                              ; preds = %173, %175
  %176 = phi i64 [ %210, %175 ], [ 0, %173 ]
  ...
  br i1 %211, label %212, label %175, !llvm.loop !28

212:                                              ; preds = %175, %173
  %213 = phi i64 [ 1, %173 ], [ 73, %175 ]
  br label %214
...
227:                                              ; preds = %214
  ...
  br i1 %229, label %230, label %173, !llvm.loop !30

230:                                              ; preds = %227, %313
  %231 = phi i64 [ %314, %313 ], [ 0, %227 ]
  br i1 %113, label %293, label %232

232:                                              ; preds = %230, %232
  %233 = phi i64 [ %291, %232 ], [ 0, %230 ]
  ...
  br i1 %292, label %293, label %232, !llvm.loop !39

293:                                              ; preds = %232, %230
  %294 = phi i64 [ 0, %230 ], [ 72, %232 ]
  br label %295
...
325:                                              ; preds = %321
  ...
  %329 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %328, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3) #7
  br label %330
...
342:                                              ; preds = %339, %333
  ...
  %346 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %343, ptr noundef nonnull @.str.5, double noundef %345) #7
...
352:                                              ; preds = %349
  ...
  %354 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %353, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.3) #7
  ...
  %358 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %357, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.8) #7
  br label %359
...
371:                                              ; preds = %368, %362
  ...
  %375 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %372, ptr noundef nonnull @.str.5, double noundef %374) #7
...
381:                                              ; preds = %378
  ...
  %383 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %382, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.8) #7
  %384 = load ptr, ptr @__stderrp, align 8, !tbaa !46
  %385 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %384, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.9) #7
  br label %386
...
398:                                              ; preds = %395, %389
  ...
  %402 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %399, ptr noundef nonnull @.str.5, double noundef %401) #7
...
408:                                              ; preds = %405
  ...
  %410 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %409, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.9) #7
  br label %411
