; ModuleID = './polybench/linear-algebra/blas/gemm/gemm.c'
...
define noundef i32 @main(i32 noundef %0, ptr noundef readonly captures(none) %1) local_unnamed_addr #0 {
  %3 = tail call ptr @polybench_alloc_data(i64 noundef 4200, i32 noundef 8) #7
  %4 = tail call ptr @polybench_alloc_data(i64 noundef 4800, i32 noundef 8) #7
  %5 = tail call ptr @polybench_alloc_data(i64 noundef 5600, i32 noundef 8) #7
  br label %6
...
43:                                               ; preds = %30
  ...
  br i1 %45, label %46, label %26, !llvm.loop !16
...
210:                                              ; preds = %202, %210
  ...
  br i1 %233, label %234, label %210, !llvm.loop !27

234:                                              ; preds = %210, %199
  %235 = phi i64 [ 0, %199 ], [ 64, %210 ]
  br label %236
...
259:                                              ; preds = %255
  ...
  %263 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %262, ptr noundef nonnull @.str.2, ptr noundef nonnull @.str.3) #7
  br label %264
...
276:                                              ; preds = %273, %267
  ...
  %280 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %277, ptr noundef nonnull @.str.5, double noundef %279) #7
...
286:                                              ; preds = %283
  ...
  %288 = tail call i32 (ptr, ptr, ...) @fprintf(ptr noundef %287, ptr noundef nonnull @.str.6, ptr noundef nonnull @.str.3) #7
