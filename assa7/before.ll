...
define internal float @compute_constants(float noundef %0) #0 !dbg !183 {
  ...
  %5 = fdiv float %4, 2.000000e+00, !dbg !191
  %6 = load float, ptr %3, align 4, !dbg !192
  %7 = fadd float %6, %5, !dbg !192
  store float %7, ptr %3, align 4, !dbg !192
  %8 = load float, ptr %2, align 4, !dbg !193
  %9 = fdiv float %8, 3.000000e+00, !dbg !194
  %10 = load float, ptr %3, align 4, !dbg !195
  %11 = fadd float %10, %9, !dbg !195
  store float %11, ptr %3, align 4, !dbg !195
  %12 = load float, ptr %2, align 4, !dbg !196
  %13 = fdiv float %12, 5.000000e+00, !dbg !197
  %14 = load float, ptr %3, align 4, !dbg !198
  %15 = fadd float %14, %13, !dbg !198
  store float %15, ptr %3, align 4, !dbg !198
  %16 = load float, ptr %2, align 4, !dbg !199
  %17 = fadd float %16, 1.000000e+00, !dbg !200
  %18 = fdiv float %17, 4.000000e+00, !dbg !201
  %19 = load float, ptr %3, align 4, !dbg !202
  %20 = fadd float %19, %18, !dbg !202
  store float %20, ptr %3, align 4, !dbg !202
  %21 = load float, ptr %2, align 4, !dbg !203
  %22 = fsub float %21, 7.000000e+00, !dbg !204
  %23 = fdiv float %22, 8.000000e+00, !dbg !205
  %24 = load float, ptr %3, align 4, !dbg !206
  %25 = fadd float %24, %23, !dbg !206
  store float %25, ptr %3, align 4, !dbg !206
  %26 = load float, ptr %3, align 4, !dbg !207
  ret float %26, !dbg !208
}
