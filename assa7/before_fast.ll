...
define nofpclass(nan inf) float @loop_div_sum(ptr nocapture noundef readonly %0, i32 noundef %1, float noundef nofpclass(nan inf) %2) local_unnamed_addr #0 !dbg !19 {
  call void @llvm.dbg.value(metadata ptr %0, metadata !26, metadata !DIExpression()), !dbg !35
  call void @llvm.dbg.value(metadata i32 %1, metadata !27, metadata !DIExpression()), !dbg !35
  call void @llvm.dbg.value(metadata float %2, metadata !28, metadata !DIExpression()), !dbg !35
  call void @llvm.dbg.value(metadata float 0.000000e+00, metadata !29, metadata !DIExpression()), !dbg !35
  call void @llvm.dbg.value(metadata i32 0, metadata !30, metadata !DIExpression()), !dbg !36
  call void @llvm.dbg.value(metadata float 0.000000e+00, metadata !29, metadata !DIExpression()), !dbg !35
  call void @llvm.dbg.value(metadata i32 0, metadata !30, metadata !DIExpression()), !dbg !36
  %4 = icmp sgt i32 %1, 0, !dbg !37
  br i1 %4, label %5, label %9, !dbg !38
...
9:                                                ; preds = %11, %3
  %10 = phi float [ 0.000000e+00, %3 ], [ %24, %11 ], !dbg !35
  ret float %10, !dbg !39

11:                                               ; preds = %5, %11
  %12 = phi i64 [ 0, %5 ], [ %25, %11 ]
  %13 = phi float [ 0.000000e+00, %5 ], [ %24, %11 ]
  call void @llvm.dbg.value(metadata float %13, metadata !29, metadata !DIExpression()), !dbg !35
  call void @llvm.dbg.value(metadata i64 %12, metadata !30, metadata !DIExpression()), !dbg !36
  %14 = getelementptr inbounds float, ptr %0, i64 %12, !dbg !40
  %15 = load float, ptr %14, align 4, !dbg !40, !tbaa !41
  %16 = trunc i64 %12 to i32, !dbg !45
  %17 = sitofp i32 %16 to float, !dbg !45
  %18 = fmul fast float %17, 5.000000e-01, !dbg !46
  %19 = fadd fast float %15, %18, !dbg !47
  call void @llvm.dbg.value(metadata float %19, metadata !32, metadata !DIExpression()), !dbg !48
  %20 = fmul fast float %19, %7
  %21 = fadd fast float %20, %13, !dbg !49
  call void @llvm.dbg.value(metadata float %21, metadata !29, metadata !DIExpression()), !dbg !35
  %22 = fadd fast float %19, 1.000000e+00, !dbg !50
  %23 = fmul fast float %22, %8
  %24 = fadd fast float %21, %23, !dbg !51
  call void @llvm.dbg.value(metadata float %24, metadata !29, metadata !DIExpression()), !dbg !35
  %25 = add nuw nsw i64 %12, 1, !dbg !52
  call void @llvm.dbg.value(metadata i64 %25, metadata !30, metadata !DIExpression()), !dbg !36
  %26 = icmp eq i64 %25, %6, !dbg !37
  br i1 %26, label %9, label %11, !dbg !38, !llvm.loop !53
}
...
define nofpclass(nan inf) float @branchy(float noundef nofpclass(nan inf) %0, float noundef nofpclass(nan inf) %1, float noundef nofpclass(nan inf) %2) local_unnamed_addr #3 !dbg !57 {
  call void @llvm.dbg.value(metadata float %0, metadata !61, metadata !DIExpression()), !dbg !73
  call void @llvm.dbg.value(metadata float %1, metadata !62, metadata !DIExpression()), !dbg !73
  call void @llvm.dbg.value(metadata float %2, metadata !63, metadata !DIExpression()), !dbg !73
  call void @llvm.dbg.value(metadata float poison, metadata !64, metadata !DIExpression()), !dbg !73
  call void @llvm.dbg.value(metadata float 0.000000e+00, metadata !65, metadata !DIExpression()), !dbg !73
  ...
  call void @llvm.dbg.value(metadata float %8, metadata !64, metadata !DIExpression()), !dbg !73
  %9 = fdiv fast float %7, %8, !dbg !77
  call void @llvm.dbg.value(metadata float %9, metadata !65, metadata !DIExpression()), !dbg !73
  ret float %9, !dbg !78
}

; Function Attrs: nofree nounwind ssp uwtable(sync)
define i32 @main() local_unnamed_addr #4 !dbg !79 {
  %1 = alloca [8 x float], align 4
  call void @llvm.dbg.value(metadata float 1.000000e+01, metadata !83, metadata !DIExpression()), !dbg !96
  call void @llvm.dbg.value(metadata float 2.000000e+00, metadata !84, metadata !DIExpression()), !dbg !96
  call void @llvm.dbg.value(metadata float 1.500000e+00, metadata !85, metadata !DIExpression()), !dbg !96
  call void @llvm.lifetime.start.p0(i64 32, ptr nonnull %1) #7, !dbg !97
  call void @llvm.dbg.declare(metadata ptr %1, metadata !86, metadata !DIExpression()), !dbg !98
  call void @llvm.dbg.value(metadata i32 0, metadata !90, metadata !DIExpression()), !dbg !99
  br label %19, !dbg !100

2:                                                ; preds = %19, %2
  %3 = phi i64 [ %14, %2 ], [ 0, %19 ]
  %4 = phi float [ %13, %2 ], [ 0.000000e+00, %19 ]
  call void @llvm.dbg.value(metadata float %4, metadata !29, metadata !DIExpression()), !dbg !101
  call void @llvm.dbg.value(metadata i64 %3, metadata !30, metadata !DIExpression()), !dbg !103
  ...
  call void @llvm.dbg.value(metadata float %10, metadata !32, metadata !DIExpression()), !dbg !108
  call void @llvm.dbg.value(metadata float poison, metadata !29, metadata !DIExpression()), !dbg !101
  %11 = fmul fast float %10, 0x3FD99999A0000000
  %12 = fadd fast float %4, 0x3FC99999A0000000, !dbg !109
  %13 = fadd fast float %12, %11, !dbg !110
  call void @llvm.dbg.value(metadata float %13, metadata !29, metadata !DIExpression()), !dbg !101
  %14 = add nuw nsw i64 %3, 1, !dbg !111
  call void @llvm.dbg.value(metadata i64 %14, metadata !30, metadata !DIExpression()), !dbg !103
  %15 = icmp eq i64 %14, 8, !dbg !112
  br i1 %15, label %16, label %2, !dbg !113, !llvm.loop !114

16:                                               ; preds = %2
  call void @llvm.dbg.value(metadata float %13, metadata !94, metadata !DIExpression()), !dbg !96
  call void @llvm.dbg.value(metadata float 0x4029249240000000, metadata !95, metadata !DIExpression()), !dbg !96
  ...
  call void @llvm.lifetime.end.p0(i64 32, ptr nonnull %1) #7, !dbg !118
  ret i32 0, !dbg !119

19:                                               ; preds = %0, %19
  %20 = phi i64 [ 0, %0 ], [ %26, %19 ]
  call void @llvm.dbg.value(metadata i64 %20, metadata !90, metadata !DIExpression()), !dbg !99
  ...
  call void @llvm.dbg.value(metadata i64 %26, metadata !90, metadata !DIExpression()), !dbg !99
  %27 = icmp eq i64 %26, 8, !dbg !127
  br i1 %27, label %2, label %19, !dbg !100, !llvm.loop !128
}

; Function Attrs: nofree nounwind
declare !dbg !130 noundef i32 @printf(ptr nocapture noundef readonly, ...) local_unnamed_addr #5
...
attributes #4 = { nofree nounwind ssp uwtable(sync) "approx-func-fp-math"="true" "frame-pointer"="non-leaf" "no-infs-fp-math"="true" "no-nans-fp-math"="true" "no-signed-zeros-fp-math"="true" "no-trapping-math"="true" "probe-stack"="__chkstk_darwin" "stack-protector-buffer-size"="8" "target-cpu"="apple-m1" "target-features"="+aes,+crc,+dotprod,+fp-armv8,+fp16fml,+fullfp16,+lse,+neon,+ras,+rcpc,+rdm,+sha2,+sha3,+v8.1a,+v8.2a,+v8.3a,+v8.4a,+v8.5a,+v8a,+zcm,+zcz" "unsafe-fp-math"="true" }
