...
62:                                               ; preds = %32
  ...
  %div.mul = fmul double %75, 1.000000e-09
  %76 = fadd double %69, %div.mul
  store double %76, ptr %16, align 8
  %77 = load volatile float, ptr %10, align 4
  %78 = fpext float %77 to double
  %79 = call i32 (ptr, ...) @printf(ptr noundef @.str, double noundef %78)
  %80 = load double, ptr %16, align 8
  %81 = call i32 (ptr, ...) @printf(ptr noundef @.str.1, double noundef %80)
  ret i32 0
}
...
define internal float @compute_constants(float noundef %0) #0 {
  ...
  %div.mul = fmul float %4, 5.000000e-01
  %5 = load float, ptr %3, align 4
  %6 = fadd float %5, %div.mul
  store float %6, ptr %3, align 4
  %7 = load float, ptr %2, align 4
  %div.mul1 = fmul float %7, 0x3FD5555560000000
  %8 = load float, ptr %3, align 4
  %9 = fadd float %8, %div.mul1
  store float %9, ptr %3, align 4
  %10 = load float, ptr %2, align 4
  %div.mul2 = fmul float %10, 0x3FC99999A0000000
  %11 = load float, ptr %3, align 4
  %12 = fadd float %11, %div.mul2
  store float %12, ptr %3, align 4
  %13 = load float, ptr %2, align 4
  %14 = fadd float %13, 1.000000e+00
  %div.mul3 = fmul float %14, 2.500000e-01
  %15 = load float, ptr %3, align 4
  %16 = fadd float %15, %div.mul3
  store float %16, ptr %3, align 4
  %17 = load float, ptr %2, align 4
  %18 = fsub float %17, 7.000000e+00
  %div.mul4 = fmul float %18, 1.250000e-01
  %19 = load float, ptr %3, align 4
  %20 = fadd float %19, %div.mul4
